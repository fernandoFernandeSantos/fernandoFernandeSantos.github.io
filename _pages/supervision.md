...
# 2026
- **Lucas Roquet, Ph.D. Student**: Dependability of Large Machine Learning Models on GPUs
- **Mario Wagner, Ph.D. Student**: Reliability of Emerging Machine Learning Accelerators
- **Maxwell Pirtle, Master M2**: Studying the time predictability and Worst-Case Execution Time on NVIDIA GPUs

# 2025
- **Lucas Roquet, Ph.D. Student**: Dependability of Large Machine Learning Models on GPUs
- **Massimiliano DiTodaro, Ph.D. Student**: Reliability of Emerging Machine Learning Accelerators
- **Mario Wagner, Ph.D. Student**: Reliability of Emerging Machine Learning Accelerators
- **Maxwell Pirtle, Master M2**: Studying the time predictability and Worst-Case Execution Time on NVIDIA GPUs
- **Mathys Minsac, Master M1**: Fault simulation and mitigation on Processing Using DRAM architectures
- **Remi Loison, Undergrad Internship**: Fault simulation on RISC-V processors
